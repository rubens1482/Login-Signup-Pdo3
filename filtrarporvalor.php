...
// SALDO CABEÇALHO DO LIVRO E DA FOLHA DIGITADA
/*
if (isset($_GET['filtrar_data'])){
	$idlivro = $_GET['livro'];
					...
					<div class="panel-heading"  > 
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xd-6" style="text-align: right;">
								<strong> FILTRAGEM POR VALOR </strong>
							</div>
						</div>	
					</div>
							...
							<div class="panel panel-danger">
								<div class="panel-body">	
									<span><strong> Filtrar Por:  </strong></span>
									  <input type="radio" class="custom-control-input" id="entradas" name="e">
									  <label class="custom-control-label" for="defaultInline1">Entradas</label>
									  <input type="radio" class="custom-control-input" id="saidas" name="saidas">
									  <label class="custom-control-label" for="defaultInline2">Saidas</label>
									  <input type="radio" class="custom-control-input" id="ambos" name="ambas">
									  <label class="custom-control-label" for="defaultInline3">Ambas</label>
									
									<span><strong> Valor Inicial: </strong></span><input type="text" name="folha_i" id="folha_i" class="form-control input-sm"  style="width:70px;" value="" >
									<span><strong> Valor 	Final: </strong></span><input type="text" name="folha_f" id="folha_f" class="form-control input-sm"  style="width:70px;" value="" >
