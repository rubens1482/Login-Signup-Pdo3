...
if(isset($_POST['btn-signup']))
{
	...
	$ufoto = strip_tags($_POST['txt_foto']);
	...
	else
	{
		try
		{
			...
			{
				if($user->register($uname,$umail,$upass,$ufoto)){	
...
<div class="container">
        ...
        <form method="post" class="form-signin">
            ...
            <br />
            <label>Já tem cadastro? <a href="login.php"> Efetuar Login </a></label>
        </form>
       </div>
</div>
